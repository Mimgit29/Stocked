...
import { getstocknameFromCSV } from './parsecsv1.js';
...
const wpApiUrl='https://profitbooking.in/wp-json/scraper/v1/stockedge-multibagger';

async function scrapeStockFeeds() {
  
  const stocks = await getstocknameFromCSV();
